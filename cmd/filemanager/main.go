...
func init() {
	...
	flag.StringVar(&infourl, "infourl", "", "URL for extenal http server in info panel")
...
func setupViper() {
	...
	viper.BindPFlag("InfoURL", flag.Lookup("infourl"))
...
func handler() http.Handler {
	...
	fm := &filemanager.FileManager{
		...
		InfoURL:         viper.GetString("InfoURL"),
